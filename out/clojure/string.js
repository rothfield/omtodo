...
{{
var G__10554 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10554;
continue;
}
} else
...
{var pred__10558 = cljs.core._EQ_;var expr__10559 = limit;if(cljs.core.truth_(pred__10558.call(null,1,expr__10559)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10558.call(null,2,expr__10559)))
...
var G__10561 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10562 = (limit__$1 - 1);
var G__10563 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10561;
limit__$1 = G__10562;
parts = G__10563;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10565 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10565))
{var replacement_10566 = temp__4090__auto___10565;buffer.append([cljs.core.str(replacement_10566)].join(''));
} else
{buffer.append(ch);
}
{
var G__10567 = (index + 1);
index = G__10567;
continue;
}
}
