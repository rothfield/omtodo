...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13272 = 0;while(true){
var m_13273 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13273 == null))
{} else
{m_13273.call(null);
if((count_13272 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13274 = (count_13272 + 1);
count_13272 = G__13274;
continue;
}
} else
{}
