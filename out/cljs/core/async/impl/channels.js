...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13278 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13278 = (function (val,box,meta13279){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13278.cljs$lang$type = true;
cljs.core.async.impl.channels.t13278.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13278";
cljs.core.async.impl.channels.t13278.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t13278");
});
cljs.core.async.impl.channels.t13278.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13278.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13280){var self__ = this;
var _13280__$1 = this;return self__.meta13279;
});
cljs.core.async.impl.channels.t13278.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13280,meta13279__$1){var self__ = this;
var _13280__$1 = this;return (new cljs.core.async.impl.channels.t13278(self__.val,self__.box,meta13279__$1));
});
cljs.core.async.impl.channels.__GT_t13278 = (function __GT_t13278(val__$1,box__$1,meta13279){return (new cljs.core.async.impl.channels.t13278(val__$1,box__$1,meta13279));
});
}
return (new cljs.core.async.impl.channels.t13278(val,box,null));
});
...
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13281))
{var take_cb_13282 = cljs.core.async.impl.protocols.commit.call(null,taker_13281);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13282,taker_13281){
return (function (){return take_cb_13282.call(null,null);
});})(take_cb_13282,taker_13281))
);
} else
{}
{
